!(function (e, t) {
    ...
    function m(e, i, s, o, a, r) {
      return (
        ...
        n(function (n, r, l, d) {
          ...
          } else (b = g(b === r ? b.splice(v, b.length) : b)), a ? a(null, r, b, d) : Q.apply(r, b);
        })
      );
    }
    function y(e) {
  ...
  ((fe.fn.init = function (e, t, i) {
    ...
    if (((i = i || xe), "string" == typeof e)) {
      ...
      return (
        (s = Z.getElementById(n[2])) && ((this[0] = s), (this.length = 1)), this
      );
    }
    return e.nodeType
  ...
  fe.fn.extend({
    val: function (e) {
      ...
      return arguments.length
        ...
        : s
        ? (t = fe.valHooks[s.type] || fe.valHooks[s.nodeName.toLowerCase()]) &&
          "get" in t &&
  ...
  return (
    (fe.noConflict = function (t) {
      return (
        e.$ === fe && (e.$ = Qt), t && e.jQuery === fe && (e.jQuery = Kt), fe
      );
    }),
    t || (e.jQuery = e.$ = fe),
    fe
        ...
        for (var i = e[0].split(" "), n = e[1], s = 0; s < i.length; s += 1)
          for (var o = i[s], a = 0; a < this.length; a += 1) {
            ...
            try {
              ...
              (l = d.createEvent("Event")).initEvent(o, !0, !0), (l.detail = n);
            }
      ...
      i.extend(g.prototype, {
        ...
        (i.fn.fancybox = function (e) {
          ...
          return (
            ...
            (t = e.selector || !1),
            t
              ? i("body").off("click.fb-start", t).on(
                  "click.fb-start",
                  t,
                  {
                    options: e,
