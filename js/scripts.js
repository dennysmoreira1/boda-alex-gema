$(document).ready(function () {
  ...
  $(".story__slider").slick({
    ...
    prevArrow:
      '<button type="button" class="slick-prev arrow-left--colored"></button>', // Flecha izquierda
    nextArrow:
      '<button type="button" class="slick-next arrow-right--colored"></button>', // Flecha derecha
  });
  //Fancybox
  // $(".fancy").fancybox({
